...
// Import the startTrip function from your Firestore service file
import { startTrip } from "../tripService";
...
export default function NavigationPage() {
  ...
  const handleStartNavigation = async () => {
    ...
    try {
      ...
      const tripId = await startTrip(firebaseUser.uid, currentLocation, destination, 0);
      ...
      navigate("/ongoingnav", {
        state: {
          ...
          nodeSequence,
          destination,
          // Pass initialPosition; here using the first node if available
          initialPosition: nodeSequence.length ? nodeSequence[0] : null,
        },
      });
    } catch (error) {
      setScanError("Error saving trip: " + error.message);
    }
  };
